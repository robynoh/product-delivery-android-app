...
public class card_week_payment extends AppCompatActivity {
    ...
    TextView total_week_card_earning;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card_week_payment);

        getSupportActionBar().show();
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Weekly Card Payment");

        lvweek =findViewById(R.id.listViewcardweek);
        ...
        total_week_card_earning=findViewById(R.id.total_week_card_earning);

        SharedPreferences sharedPreferences = getSharedPreferences("myKey", MODE_PRIVATE);
        riderid = sharedPreferences.getString("pilotID", "");

        pull_all_card_payment_weekly(riderid);

    }

    private void pull_all_card_payment_weekly(String riderid) {



        // Building the url to the web service
        String URL = "https://www.troopa.org/api/pull-card-payment-weekly/"+riderid;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    total_week_card_earning.setText(obj.getString("weeklyCard"));
                    ...
                    adapter = new   card_payment_list_adapter(card_week_payment.this,R.layout.card_payment_list, arrayList);
