...
public class cash_payment_list_adapter extends ArrayAdapter<all_cash_payments> {
    RequestQueue queue;
    ArrayList<all_cash_payments> products;
    Context context;
    int resource;
    private RadioGroup radioGroup;
    private cash_payment_list_adapter adapter;


    public cash_payment_list_adapter(Context context, int resource, ArrayList<all_cash_payments> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.cash_payment_list, null, true);

        }
        all_cash_payments product = getItem(position);
