...
public class daily_card_payment extends AppCompatActivity {
    ...
    TextView daily_card_payment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_daily_card_payment);

        getSupportActionBar().show();
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Daily Card Payment");


        lvday =findViewById(R.id.listViewdaycard);
        ...
        daily_card_payment=findViewById(R.id.daily_card_payment);
        ...
        pull_all_card_payment_daily(riderid,day,month,year);



    }

    private void pull_all_card_payment_daily(String riderid,String day,String month, String year) {



        // Building the url to the web service
        String URL = "https://www.troopa.org/api/pull-card-payment-daily/"+riderid+"/"+day+"/"+month+"/"+year;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    daily_card_payment.setText(obj.getString("dailyCard"));
                    ...
                    adapter = new   card_payment_list_adapter(daily_card_payment.this,R.layout.card_payment_list, arrayList);
