...
public class real_order_list_adapter extends ArrayAdapter<all_real_order_list> {
    RequestQueue queue;
    ArrayList<all_real_order_list> products;
    Context context;
    int resource;
    private RadioGroup radioGroup;
    private real_order_list_adapter adapter;


    public real_order_list_adapter(Context context, int resource, ArrayList<all_real_order_list> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.real_orders, null, true);

        }
        all_real_order_list product = getItem(position);
...
//        Picasso.with(getContext()).load(product.getImage()).into(image);
        ...
        TextView pickupvaluex = (TextView) convertView.findViewById(R.id.pickupvalue);
        pickupvaluex.setText(product.pickup_location());
