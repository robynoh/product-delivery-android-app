...
public class week_sort extends AppCompatActivity {
    ArrayList<all_cash_payments> arrayList;
    ListView lvweek;
    TextView total_week_cash_earning;
    String riderid;
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Weekly Cash Payment");


        lvweek =findViewById(R.id.listViewweek);
        ...
        total_week_cash_earning=findViewById(R.id.total_week_cash_earning);
        arrayList = new ArrayList<>();
        SharedPreferences sharedPreferences = getSharedPreferences("myKey", MODE_PRIVATE);
        riderid = sharedPreferences.getString("pilotID", "");

        pull_all_cash_payment_weekly(riderid);
    }

    private void pull_all_cash_payment_weekly(String riderid) {



        // Building the url to the web service
        String URL = "https://www.troopa.org/api/pull-cash-payment-weekly/"+riderid;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    total_week_cash_earning.setText(obj.getString("weeklyCash"));
                    ...
                    adapter = new   cash_payment_list_adapter(week_sort.this,R.layout.cash_payment_list, arrayList);
